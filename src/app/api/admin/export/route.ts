...
function warConstantsRows(data: ParsedSheetData): Cell[][] {
  ...
  return [
    ...
    [],
    ['Replacement PPR (the WAR bar)', b.replacementNppr.toFixed(4)],
    ['Replacement team win rate it is anchored to', '0.294'],
    ['Observed 25th percentile NPPR (reported, not used)', b.observedP25Nppr.toFixed(4)],
    ...
    [],
    ['NOTE', 'Replacement PPR is anchored where a whole team of such fighters would win 29.4% of their matches \u2014 the convention baseball uses (1,000 WAR per 2,430 team-games) \u2014 solved through the win-probability table. It is NOT the 25th percentile of observed NPPR: fighters who appeared in a single round score \u00b14.00 and dominate the low tail, which put the bar at -2.004, a rate at which a team never wins a match.'],
    [],
